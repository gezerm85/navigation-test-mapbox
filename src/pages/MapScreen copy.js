...
const MapScreen = () => {
  ...
  useEffect(() => {
    if (selectedPolygon && (userLocation || fakeUserLocation)) {
      calculateRoute();
    }
  ...
  const calculateRoute = () => {
    ...
    setTimeout(() => {
      ...
      const bufferDistance = routeMode === "walking" ? 0.00005 : 0.0010; // Yürüyüş için 5 cm, araç için 20 cm
      ...
      if (shortestPath) {
        ...
        const approxDuration = (length / speed) * 60; // Süreyi dakika cinsine çevir
